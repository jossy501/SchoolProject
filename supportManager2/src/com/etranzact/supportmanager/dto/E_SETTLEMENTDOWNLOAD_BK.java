 ...
 *
 */
public class E_SETTLEMENTDOWNLOAD_BK 
{
	...
	public String getCard_num_acct() {
		return card_num_acct;
	}

	public void setCard_num_acct(String card_num_acct) {
		this.card_num_acct = card_num_acct;
	}

	public String getMerchant_code_actt() {
		return merchant_code_actt;
	}

	public void setMerchant_code_actt(String merchant_code_actt) {
		this.merchant_code_actt = merchant_code_actt;
	}
