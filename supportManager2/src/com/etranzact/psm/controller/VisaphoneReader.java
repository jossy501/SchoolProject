...
public class VisaphoneReader {
    ...
    public VisaphoneReader(User user,String user_code, String clientIP, String user_id, int pinLength, String network, int totalCount, String fileName, java.io.File inputfullFileName, double totalPinAmount, List<TPsmStock> list, List<ErrorBean> invalid, String systemBatchNumber, String batchNumber) {
    ...
    public List<String> readFile(double amount,String user_code, String clientIP, String user_id, int pinLength, String network,
...
//                                            + "'" + stock.getPinId() + "',getdate(), '" + user.getUser_id() + "', 'A','" + stock.getProviderId() + "','')";
    ...
    public static void main(String d[]) {
        try {
            FileInputStream fstream = new FileInputStream("C:\\ddd.txt");
            DataInputStream in = new DataInputStream(fstream);
            BufferedReader br = new BufferedReader(new InputStreamReader(in));
            String strLine;
            while ((strLine = br.readLine()) != null) {
            System.out.println("<f:selectItem itemLabel=\""+strLine+"\" itemValue=\"111_"+strLine.replaceAll(" ","").replaceAll("'","")+"\" />");
