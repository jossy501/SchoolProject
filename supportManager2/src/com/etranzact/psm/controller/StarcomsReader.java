...
public class StarcomsReader {
    ...
    public StarcomsReader(User user,String user_code, String clientIP, String user_id, int pinLength, String network, int totalCount, String fileName, java.io.File inputfullFileName, double totalPinAmount, List<TPsmStock> list, List<ErrorBean> invalid, String systemBatchNumber, String batchNumber) {
    ...
    public List<String> readFile(User user,double amount,String user_code, String clientIP, String user_id, int pinLength, String network,
...
//                                            + "'" + stock.getPinId() + "',getdate(), '" + user.getUser_id() + "', 'A','" + stock.getProviderId() + "','')";
    ...
    public static void main(String d[]) {
        try {
            FileInputStream fstream = new FileInputStream("C:\\Users\\akachukwu.ntukokwu\\Downloads\\sample%20pins\\sample pins\\starcoms sample.txt");
            DataInputStream in = new DataInputStream(fstream);
            BufferedReader br = new BufferedReader(new InputStreamReader(in));
            String strLine;
            while ((strLine = br.readLine()) != null) {
